['index', 'page_category', 'page_showService', 'page_serviceList', 'page_serviceEdit', 'page_postServiceEdit', 'page_reserveEdit', 'page_postReserveEdit', 'page_reserveList']
# karrigell modules
...
modules = {'pagefn' : 'pagefn.py','formRender' : 'formRender.py', 'config' : 'backgroundConfig.py' }
