...
root_dir = os.path.join(server_dir,"cms")
data_dir = os.path.join(server_dir,"data","cms")
...
#global_modules = [os.path.join(root_dir, 'model.py')] #[os.path.join(root_dir,"demo","tour","aaa.py")]
