['index', 'login', 'logout', 'showComments', 'new_blog_entry', 'create_new_blog', 'make_new_blog', 'settings', 'update_settings', 'insert_blog_entry', 'insert_comment', 'edit_blog_entry', 'search', 'delete_blog_entry']
import os
import datetime
import calendar
import locale
