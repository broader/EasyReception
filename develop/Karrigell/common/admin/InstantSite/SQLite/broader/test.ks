"""Database management
Generated 12/06/08 22:27:18"""

base_name = r"C:\Karrigell\20081206\essai"
name = "test"
fields = (("name","TEXT","input"),("age","TEXT","input"))
__id__ = "_ROWID_"
import os
...
def insertRecord(record_id,**untyped_fields):
    ...
    if CONFIG.output_encoding is not None:
        sql = unicode(sql,CONFIG.output_encoding)
    else:
        sql = unicode(sql)
    try:
        cursor.execute(sql)
