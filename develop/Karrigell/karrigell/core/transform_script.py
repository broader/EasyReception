...
if __name__=="__main__":
    ...
    def testone():
        #obj = cStringIO.StringIO(open("copypy.py").read())
        obj = cStringIO.StringIO(open("issue.ks").read())
        out = cStringIO.StringIO()
        ...
        x = transform(obj,out,func=trans_print,debug=True)
        print x
        #res = open("copypy.py","w")
        #res.write(out.getvalue())
        #res.close()
    ...
    def test_ks_functions():
    	obj = cStringIO.StringIO(open("issue.ks").read())
        out = cStringIO.StringIO() 
        from k_target import translate_func
    	print transform(obj,out,func=translate_func,debug=True).functions
    #testall()
    #testone()
    #test_ks_functions()
