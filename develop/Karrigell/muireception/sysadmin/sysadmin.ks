...
GRIDID, FILTERINPUTID,FILTERBN,FILTERCLEARBN = ('classListGrid', 'filterInput','filterbn','filtereset')
...
def _classEditJs(klass):
	paras = [CLASSPROP, klass, APP, GRIDID]
	...
	js = \
	"""
	var klassprop='%s', klass='%s', appName='%s', gridId='%s',
