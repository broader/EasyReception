...
def page_showPortfolio(**args):
	...
	valueStyle = {'label':'color:#ff6600;font-size:1.2em;', 'td':'text-align:center;',\
					  'textarea':'width:20em;color:#ff6600;font-size:1.2em;'}
	
	trs = formFn.render_table_fields( newFields, 1, labelStyle, valueStyle)
	table.append(trs)
	...
	div = DIV( button, **{ 'id':PORTFOLIOEDITBN, 'style':'position:absolute;margin-left:12em;'})	
	main.append(div)	
	print Sum(main)	
	return
